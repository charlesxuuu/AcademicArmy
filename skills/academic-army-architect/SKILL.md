...
Use evidence returned by `academic_army_mcp_tools.deepresearch` to establish venue posture, related-work boundary, exemplar-derived story patterns, evidence posture, and reviewer-context pressure.
