...
- `npm run developing-skill`：运行带 `trajectory-optimizer` hook 的开发循环，可根据具体开发反馈优化 coding-style skill。
...
- [`runs/develop-skill.sh`](../runs/develop-skill.sh) 调用 `npm run developing-skill`。
