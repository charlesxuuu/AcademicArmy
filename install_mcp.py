...
parser.add_argument("--timeout", type=int, default=3600, metavar="SECONDS", help="MCP tool timeout in seconds.")
...
doctor = subprocess.run([codex, "doctor", "--json"], check=True, capture_output=True, text=True)
